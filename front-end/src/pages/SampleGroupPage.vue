<template>
  ...
  <PageHeader>
    <div class="text-2xl font-bold pl-5">Sample Groups</div>
    <div class="text-sm ml-5">Add or remove sample groups</div>
    <div>
      <button class="mx-5 group-modify-btn" @mouseup="showAdder = true">
        <SvgIcon class="h-5 w-5" name="PlusSm" />
      </button>
      <button class="group-modify-btn" @mouseup="showRemover = true">
...
import GroupList from '@/components/SampleGroup/GroupList.vue'
import GroupTestList from '@/components/SampleGroup/GroupTestList.vue'
