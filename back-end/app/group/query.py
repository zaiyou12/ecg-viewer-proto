...
def q_make_link_ecgtest_testgroup(ecgtest_id, testgroup_id):
...
def q_delete_link_ecgtest_testgroup(ecgtest_id, testgroup_id):
...
##### ----- Delete Link ECGTest-TestGroup
def q_get_testlink(ecgtest_id, testgroup_id):
...
def q_get_samplelink(ecgtest_id, page, samplegroup_id):
...
def q_make_link_ecgtest_samplegroup(ecgtest_id, page, samplegroup_id):
...
##### ----- Delete Link ECGTest-SampleGroup
def q_delete_link_ecgtest_samplegroup(ecgtest_id, page, samplegroup_id):
...
def q_create_groupdata(ty, group_name, group_status, path):
    if ty == "t":
